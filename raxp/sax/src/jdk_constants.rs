...
// jdk/build/linux-x86_64-server-release/support/src/src/java.xml/share/classes/java.xml/jdk/xml/internal/JdkConstants.java
...
impl JdkConstants {
    ...
    // TODO: deprecation warning
    pub const JDK_ENTITY_EXPANSION_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "entityExpansionLimit");
    // TODO: deprecation warning
    pub const JDK_ELEMENT_ATTRIBUTE_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "elementAttributeLimit");
    // TODO: deprecation warning
    pub const JDK_MAX_OCCUR_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "maxOccurLimit");
    // TODO: deprecation warning
    pub const JDK_TOTAL_ENTITY_SIZE_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "totalEntitySizeLimit");
    // TODO: deprecation warning
    pub const JDK_GENERAL_ENTITY_SIZE_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "maxGeneralEntitySizeLimit");
    // TODO: deprecation warning
    pub const JDK_ENTITY_REPLACEMENT_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "entityReplacementLimit");
    // TODO: deprecation warning
    pub const JDK_PARAMETER_ENTITY_SIZE_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "maxParameterEntitySizeLimit");
    // TODO: deprecation warning
    pub const JDK_XML_NAME_LIMIT: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "maxXMLNameLimit");
    // TODO: deprecation warning
    pub const JDK_MAX_ELEMENT_DEPTH: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "maxElementDepth");
    // TODO: deprecation warning
    pub const JDK_ENTITY_COUNT_INFO: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "getEntityCountInfo");
    ...
    // TODO: deprecation warning
    pub const FQ_IS_STANDALONE: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, JdkConstants::S_IS_STANDALONE);
    ...
    pub const ORACLE_ENABLE_EXTENSION_FUNCTION: &str = combine!(JdkConstants::ORACLE_JAXP_PROPERTY_PREFIX, "enableExtensionFunctions");
