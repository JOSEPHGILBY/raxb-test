...
impl Constants {
    ...
    pub const READER_IN_DEFINED_STATE: &str = concatcp!(Constants::ZEPHYR_PROPERTY_PREFIX, "reader-in-defined-state");
    ...
    pub const SECURITY_MANAGER: &str = concatcp!(Constants::XERCES_PROPERTY_PREFIX, Constants::SECURITY_MANAGER_PROPERTY);
    ...
    const fg_xerces_features: &'static [&'static str] = &[
        ...
        //Constants::GRAMMAR_ACCESS_FEATURE,
